    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          {/* Front */}
          <div
            className="absolute w-full h-full bg-gradient-to-br from-purple-600/40 to-pink-600/40 border border-purple-500/50 rounded-2xl p-8 flex flex-col items-center justify-center backdrop-blur-md"
            style={{ backfaceVisibility: 'hidden' }}
          >
            <div className="text-8xl mb-4">{currentCard.imageEmoji}</div>
            <h3 className="text-3xl font-bold text-center text-amber-400 mb-4">
              {currentCard.name}
            </h3>
            <p className="text-gray-300 text-center text-lg">
              {currentCard.arcana} • {currentCard.suit || 'N/A'}
            </p>
            <p className="text-gray-400 text-center mt-4 text-sm">Nhấn để xem ý nghĩa</p>
          </div>
